  ...
  return (
    <>
      <div className="w-full text-gray-900">
        <ChurchHero title="Our Pastor" onWatchLive={triggerWatchLive} />
        ...
        <section className="sm:max-w-[80%] mx-auto py-20 px-4">
          ...
          <div className="relative">
            ...
            <div className="grid md:grid-cols-5 gap-12 md:gap-24 items-start transition-opacity duration-500">
