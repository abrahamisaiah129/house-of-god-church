    ...
    <main className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mb-6 text-gray-300">
          This page demonstrates the improved welcome popup. The popup will open automatically when the
          page loads. Use the top controls to minimize, fullscreen, or close the popup. Press <kbd>Esc</kbd>
        ...
        <section className="bg-gray-800 p-6 rounded-lg mb-6">
          ...
          <ul className="list-disc list-inside text-gray-300">
            ...
            <li>Backdrop click and <kbd>Esc</kbd> close the popup</li>
        ...
        <p className="text-sm text-gray-400 mb-8">Render area below — popup component will mount itself.</p>

        {/* Mount the popup component (it opens itself) */}
        <WelcomeVideoPopup />
      </div>
    </main>
  );
